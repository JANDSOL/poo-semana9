class Prestamo:
    ...
    def __init__(self, fec='', valo=0, num_pag=0, emp='') -> None:
        ...
        self.__saldo = self.__calcular_saldo(self.numero_pagos, self.__cuota)
    ...
    def __calcular_saldo(self, numero_pagos, cuota) -> float:
        if numero_pagos != 0:
            return round(((numero_pagos * cuota)-cuota), 2)
        else:
            return 0
